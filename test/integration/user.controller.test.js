    ...
    it('TC-201-4 User already exist', (done) => {
        chai.request(server)
            ...
            .end((req, res) => {
                ...
                let { status, result } = res.body;
                status.should.equals(400);
                result.should.be.a('string').that.equals('User already exist!');
                done();
            });
    });
    ...
    it('TC-204-2 User-ID dont exist', (done) => {
        chai.request(server)
            ...
            .end((req, res) => {
                ...
                let { status, result } = res.body;
                status.should.equals(404);
                result.should.be.a('string').that.equals('User-ID dont exist!');
                done();
            });
    });
    ...
    it('TC-205-4 User dont exist', (done) => {
        chai.request(server)
            ...
            .end((req, res) => {
                ...
                let { status, result } = res.body;
                status.should.equals(400);
                result.should.be.a('string').that.equals('User dont exist!');
                done();
            });
    });
